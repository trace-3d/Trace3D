...
from scene.read_llff import read_llff_data
...
class Scene:
    ...
    def __init__(self, args: ModelParams, gaussians: GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0]):
        ...
        elif 'nerf_llff_data' in args.source_path:
            print("Assuming llff data set!")
            scene_info = read_llff_data(args.source_path, args.eval, args.sam_folder)
