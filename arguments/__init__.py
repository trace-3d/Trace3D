...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        self.read_sam_features = False
        self.read_sam_mask = False
        self.sam_folder = "-"
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.densify_grad_threshold = 0.0002#不乘0.5

        self.include_feature=False#render feature
        self.instance_feature_lr=0.005
        self.contrastive=False#contrastive lifting
        ...
        self.num_class = 32#max_class_nums
        self.prune = False
        self.split = False
        ...
        self.weight_contr_interval=20
        self.k_3d = 3
        self.temp_3d =50
        self.sample_size_3d=100_000
